...
<head>
    ...
    <title>LABRAK - DP3A Manado</title>
...
<header>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav m-auto text-white">
                        ...
                        <li class="nav-item me-5">
                            <a class="nav-link text-white fw-bold" href="profile_dinas.php">PROFIL DINAS</a>
                        </li>
                        <li class="nav-item me-5">
        ...
        <main class="mb-5">
             ...
             <!-- KONTAK -->
              <br><br><br>
              <h2 class="text-white text-center">UPTD-PPA Kota Manado</h2>

      


              <div class="container w-50 shadow mt-5 pb-3 pt-3 bg-white" style="width:60% !important;">
                <br><br>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="media">
                                ...
                                <script>
                                    function myMap() {
                                      ...
                                      var myCenter = new google.maps.LatLng(-7.0502444, 112.733275);
                                      ...
                                      marker.setMap(map);
                                          ...
                                          <iframe
                                              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.479754388882!2d124.84977509999999!3d1.4842022999999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x328775981f591fcf%3A0xec51442cdee085f4!2sDinas%20Pemberdayaan%20Perempuan%20dan%20Perlindungan%20Anak%20Kota%20Manado!5e0!3m2!1sid!2sid!4v1710902843668!5m2!1sid!2sid"
                                      ...
                                      <br><br>
                                      <h4>KANTOR</h4>
                                        <p>Jl. Balaikota No.01 Tikala Ares Manado, Sulawesi Utara</p>
                                        <hr />
                                    <h4>Contact Info:</h4>
                                        <p>Call Center 112 (BEBAS PULSA)</p>
                                        <p>0852-2004-4323</p>
                                        <a href="https://dpppa.manadokota.go.id/" target="_blank">dpppa.manadokota.go.id</a>
                                        <p>&nbsp;</p>
